...
be extracted from the available data set, the related Fourier coefficients,
 ...
 relative to the leading amplitudes at H{\sc ermes} kinematic conditions. {The constant K is defined in ref.~\cite{Bel02b}}.}
