...
approximately 246\,pb$^{-1}$ and 1460\,pb$^{-1}$\blue{,} with average beam polarisation\blue{s} of 30.3\,\% and 39.2\% \cite{2001}. The procedure used to select events is identical to that used in Ref.~\cite{2009a}.
...
upon this $\mathcal{C}$-function. However, the $A^{\cos(0\phi)}_{\textrm{C}}$ \blue{amplitude} is kinematically suppressed compared to the $A^{\cos\phi}_{\textrm{C}}$ amplitude, whereas the  $A_{\textrm{LU,I}}^{\sin(2\phi)}$ and $A^{\cos(2\phi)}_{\textrm{C}}$ \blue{amplitudes} enter the cross section at a higher
...
be extracted from the available data set, the related Fourier coefficients,
 the $\mathcal{C}$-functions, the twist level and the suppression \blue{at H{\sc ermes} kinematic conditions}~\cite{Belitsky2002}.}
