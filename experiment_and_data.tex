...
coefficients $s_{n}^{W}$ and $c_{n}^{I}$ from the interference and
...
Eqs.~\ref{e:alui}-\ref{e:ac}. The  $s_{n}^{W}$ and $c_{n}^{V}$ Fourier
...
and therefore GPD $H$. \red{Therefore}, $H$ can be constrained through
...
where $\alpha_{\textrm{S}}$ is the\red{strong} constant.
\begin{table}
\begin{center}
\resizebox{\textwidth}{!} {
