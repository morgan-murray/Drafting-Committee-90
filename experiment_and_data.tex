...
upon this $\mathcal{C}$-function. However, the
$A^{\cos(0\phi)}_{\textrm{C}}$ amplitude is kinematically suppressed
compared to the $A^{\cos\phi}_{\textrm{C}}$ amplitude, and the
$A_{\textrm{LU,I}}^{\sin(2\phi)}$ and $A^{\cos(2\phi)}_{\textrm{C}}$
amplitudes \red{depend upon} higher twist quantities (see Table~\ref{tab_amplitudes}).
...
where $\alpha_{\textrm{S}}$ is the strong coupling constant. Table~\ref{tab_amplitudes} presents the asymmetry amplitudes extracted in this analysis and the
related Fourier coefficients, dominant $\mathcal{C}$-function, twist-level and level of suppression.
\begin{table}
\begin{center}
\resizebox{\textwidth}{!} {
...
$\mathfrak{Re}\mathcal{C}_{\textrm{unp}}^{\textrm{I}}$ & 2& $\frac{(2-y)^3K}{(1-y)(2-2y+y^2)}$
\\
\hline
