...
# t
hermes_ac_6bin_t=[[-0.017,-0.05,-0.012,-0.016,-0.040,-0.072],
...
ylabel="$A^{I}_{LU}\,\sin(\phi)$"

set_axis_opts(xlims,xticks,xticklabels,xlabel,
              ylims,yticks,yticklabels,ylabel)

# HERMES 4-bin 'classic'
plt.errorbar(taxis,hermes_alu_I_t[0],hermes_alu_I_t_d_total[0],
             marker='s',ms=5,mfc='red',ls='None',c="red",label="HERMES 4-bin")

# HERMES 6-bin 'classic'
ax.errorbar(taxis2,hermes_alu_I_6bin_t[0],hermes_alu_I_6bin_t_d_total[0],
            marker="^",ms=5,mfc='blue',ls='None',c="blue",label="HERMES 6-bin")

# -- sin(2\phi)
ax = plt.subplot(3,3,4)

ylabel = "$A^{I}_{LU}\,\sin(2\phi)$"

set_axis_opts(xlims,xticks,xticklabels,xlabel,
              ylims,yticks,yticklabels,ylabel)

# HERMES 4-bin 'classic'
plt.errorbar(taxis,hermes_alu_I_t[1],hermes_alu_I_t_d_total[1],
             marker='s',ms=5,mfc='red',ls='None',c="red")

# HERMES 6-bin 'classic'
ax.errorbar(taxis2,hermes_alu_I_6bin_t[1],hermes_alu_I_6bin_t_d_total[1],
            marker="^",ms=5,mfc='blue',ls='None',c="blue",label="HERMES 6-bin")
...
# HERMES 4-bin "classic"
plt.errorbar(xaxis,hermes_alu_I_x[0],hermes_alu_I_x_d_total[0],
             marker='s',ms=5,mfc='red',ls='None',c="red")

# HERMES 6-bin 'classic'
ax.errorbar(xaxis2,hermes_alu_I_6bin_x[0],hermes_alu_I_6bin_x_d_total[0],
            marker="^",ms=5,mfc='blue',ls='None',c="blue",label="HERMES 6-bin")
...
# HERMES 4-bin 'classic'
plt.errorbar(xaxis,hermes_alu_I_x[1],hermes_alu_I_x_d_total[1],
             marker='s',ms=5,mfc='red',ls='None',c="red")

# HERMES 6-bin 'classic'
ax.errorbar(xaxis2,hermes_alu_I_6bin_x[1],hermes_alu_I_6bin_x_d_total[1],
            marker="^",ms=5,mfc='blue',ls='None',c="blue",label="HERMES 6-bin")
...
# HERMES "classic"
plt.errorbar(qaxis,hermes_alu_I_q[0],hermes_alu_I_q_d_total[0],
             marker='s',ms=5,mfc='red',ls='None',c="red")

# HERMES 6-bin 'classic'
ax.errorbar(qaxis2,hermes_alu_I_6bin_q[0],hermes_alu_I_6bin_q_d_total[0],
            marker="^",ms=5,mfc='blue',ls='None',c="blue",label="HERMES 6-bin")
...
plt.errorbar(qaxis,hermes_alu_I_q[1],hermes_alu_I_q_d_total[1],
             marker='s',ms=5,mfc='red',ls='None',c="red")

# HERMES 6-bin 'classic'
ax.errorbar(qaxis2,hermes_alu_I_6bin_q[1],hermes_alu_I_6bin_q_d_total[1],
            marker="^",ms=5,mfc='blue',ls='None',c="blue",label="HERMES 6-bin")




# HERMES DVCS 'classic' 6-bin
...
yticks = sinphiticks
yticklabels=[str(x) for x in yticks]
ylabel="$A^{DVCS}_{LU}\,\sin(\phi)$"

set_axis_opts(xlims,xticks,xticklabels,xlabel,
              ylims,yticks,yticklabels,ylabel)

plt.errorbar(taxis,hermes_alu_dvcs_t,hermes_alu_dvcs_t_d_total,
            marker="s",ms=5,mfc="red",ls="None",c="red")

ax.errorbar(taxis2,hermes_alu_DVCS_6bin_t,hermes_alu_DVCS_6bin_t_d_total,
            marker='^',ms=5,mfc='blue',ls='None',c='blue',label='HERMES Classic 6-bin')
...
yticklabels=["" for x in yticks]
ylabel=""

set_axis_opts(xlims,xticks,xticklabels,xlabel,
              ylims,yticks,yticklabels,ylabel)

plt.errorbar(xaxis,hermes_alu_dvcs_x,hermes_alu_dvcs_x_d_total,
             marker="s",ms=5,mfc="red",ls="None",c="red", label="HERMES 4-bin")

ax.errorbar(xaxis2,hermes_alu_DVCS_6bin_x,hermes_alu_DVCS_6bin_x_d_total,
            marker='^',ms=5,mfc='blue',ls='None',c='blue',label='HERMES 6-bin')
...
plt.errorbar(qaxis,hermes_alu_dvcs_q,hermes_alu_dvcs_q_d_total,
             marker="s",ms=5,mfc="red",ls="None",c="red")

ax.errorbar(qaxis2,hermes_alu_DVCS_6bin_q,hermes_alu_DVCS_6bin_q_d_total,
            marker='^',ms=5,mfc='blue',ls='None',c='blue',label='HERMES Classic 6-bin')


plt.savefig("hermes_alu_four_bins_against_six.pdf")
...
# HERMES 6-bin
ax.errorbar(taxis2,hermes_ac_6bin_t[0],hermes_ac_6bin_t_d_total[0],
             marker='x',ms=5,mfc='blue',ls='None',c="blue")
...
# HERMES 6-bin
ax.errorbar(taxis2,hermes_ac_6bin_t[1],hermes_ac_6bin_t_d_total[1],
             marker='x',ms=5,mfc='blue',ls='None',c="blue")
...
# HERMES 6-bin
ax.errorbar(taxis2,hermes_ac_6bin_t[2],hermes_ac_6bin_t_d_total[2],
             marker='x',ms=5,mfc='blue',ls='None',c="blue")
...
# HERMES 6-bin
ax.errorbar(taxis2,hermes_ac_6bin_t[3],hermes_ac_6bin_t_d_total[3],
             marker='x',ms=5,mfc='blue',ls='None',c="blue")
...
# HERMES 6-bin
ax.errorbar(xaxis2,hermes_ac_6bin_x[0],hermes_ac_6bin_x_d_total[0],
             marker='x',ms=5,mfc='blue',ls='None',c="blue")
...
# HERMES 6-bin
ax.errorbar(xaxis2,hermes_ac_6bin_x[1],hermes_ac_6bin_x_d_total[1],
             marker='x',ms=5,mfc='blue',ls='None',c="blue")
...
# HERMES 6-bin
ax.errorbar(xaxis2,hermes_ac_6bin_x[2],hermes_ac_6bin_x_d_total[2],
             marker='x',ms=5,mfc='blue',ls='None',c="blue")
...
plt.errorbar(xaxis,hermes_ac_x[3],hermes_ac_x_d_total[3],
             marker='+',ms=5,mfc='red',ls='None',c="red",label="HERMES 4-bin")

# HERMES 6-bin
ax.errorbar(xaxis2,hermes_ac_6bin_x[3],hermes_ac_6bin_x_d_total[3],
             marker='x',ms=5,mfc='blue',ls='None',c="blue",label="HERMES 6-bin")
...
handles, labels = ax.get_legend_handles_labels()
leg_spec = matplotlib.font_manager.FontProperties(size="small")
ax.legend(handles,labels,loc="upper center",mode="expand",numpoints=1,prop=leg_spec)
...
# HERMES 6-bin
ax.errorbar(qaxis2,hermes_ac_6bin_q[0],hermes_ac_6bin_q_d_total[0],
             marker='x',ms=5,mfc='blue',ls='None',c="blue")
...
# HERMES 6-bin
ax.errorbar(qaxis2,hermes_ac_6bin_q[1],hermes_ac_6bin_q_d_total[1],
             marker='x',ms=5,mfc='blue',ls='None',c="blue")
...
# HERMES 6-bin
ax.errorbar(qaxis2,hermes_ac_6bin_q[2],hermes_ac_6bin_q_d_total[2],
             marker='x',ms=5,mfc='blue',ls='None',c="blue")
...
# HERMES 6-bin
ax.errorbar(qaxis2, hermes_ac_6bin_q[3], hermes_ac_6bin_q_d_total[3],
             marker='x',ms=5,mfc='blue',ls='None',c="blue")

# Save the a_c figure
plt.savefig("hermes_ac_four_bins_against_six.pdf")
