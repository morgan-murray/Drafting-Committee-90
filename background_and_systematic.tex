...
production \red{is predominantly due to the misidentification of
  $\pi^0$ mesons}. The procedure is described in detail in
...
region. \red{Each  measurement in the $-t$, $x_{\textrm{B}}$ and
  $Q^{2}$ projections has this uncertainty included as part of the
  total systematic uncertainty.}

\red{The} contribution to the systematic uncertainties from the relative shift of the
...
spectrometer~\cite{Air09}, which has been eliminated for the 2006-2007 data sample \red{due to improved
  surveying measurements of the spectrometer~\cite{Bur10}. The contribution from
each uncertainty to each amplitude extracted in a single kinematic bin
from the 2006-07 data  is summarised in Table
...
independent scale uncertainty. \red{The systematic uncertainty quoted for each
