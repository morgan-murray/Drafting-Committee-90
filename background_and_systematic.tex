...
The data sample in the exclusive region contains events involving both production of real photons in which the proton remains intact and events involving the excitation of the target proton to a $\Delta^+$ resonant state. \blue{The} recoiling proton is not detected \blue{and the calorimeter resolution does not allow}, separation of the latter events from rest of the data sample is not possible due to the experimental technique.
