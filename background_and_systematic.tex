...
\blue{The data sample in the exclusive region contains events involving both production of real photons in which the proton remains intact and events involving the excitation of the target proton to a $\Delta^+$ resonant state. As the recoiling proton is not detected, separation of the latter events from the data sample is not possible.}
