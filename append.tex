...
\hline
 ...
 \end{center}
\caption{Results of the extraction of $A_{\textrm{LU,I}}^{\sin(n\phi)}$ and \blue{$A_{\textrm{LU,DVCS}}^{\sin \phi}$} \blue{asymmetry} amplitudes with statistical and systematic uncertainties and average kinematics from unpolarised hydrogen taken during
the 2006-2007 experimental data taking period at \blue{H{\sc ermes}} for each $-t$, $x_{\textrm{B}}$ and $Q^{2}$ bin.
An additional 3.4\,\% scale uncertainty is present in the amplitudes due to the \blue{im}precision of
...
\hline
 ...
 \end{center}
\caption{Results of the combination of the $A_{\textrm{LU,I}}^{\sin(n\phi)}$ and \blue{$A_{\textrm{LU,DVCS}}^{\sin \phi}$} \blue{asymmetry} amplitudes with statistical and systematic uncertainties and average kinematics from unpolarised hydrogen taken during
the 1996-2007 experimental data taking period at \blue{H{\sc ermes}} for each $-t$, $x_{\textrm{B}}$ and $Q^{2}$ bin.
An additional 3.2\,\% scale uncertainty is present in the amplitudes due to the \blue{im}precision of
the beam polarisation measurement.
}
\end{table}
...
\hline
 ...
 \end{center}
\caption{Results of the combination of the $A_{\textrm{C}}^{\cos(n\phi)}$ \blue{asymmetry} amplitudes with statistical and systematic uncertainties and average kinematics from unpolarised hydrogen taken during
the 1996-2007 experimental data taking period at \blue{H{\sc ermes}} for each $-t$, $x_{\textrm{B}}$ and $Q^{2}$ bin.}
\end{table}
}
