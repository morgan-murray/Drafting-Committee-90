...
missing-mass event selection technique. The beam-charge asymmetry amplitudes extracted from the new data set are statistically more precise than those extracted from \blue{the} earlier data set of 1996-2005 previously analysed in the same manner by the collaboration. Results from \blue{the two} data sets are found to be compatible with each other. Combined results from these data sets are extracted and \blue{represent} the statistically most precise asymmetry amplitude measurements available in the \blue{H{\sc ermes}} kinematic region.
\end{abstract}
