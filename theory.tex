...
desccription of the nucleon in terms of GPDs would allow a description
of the total angular momentum of partons in the nucleon as wall as a
...
$x-\xi$. (b): The emission of a real photon from the scattering or
scattered lepton, called the Bethe-Heitler process. It has the same initial and final states as DVCS.}
\label{spin}
\end{center}
\end{figure}
...
of the BH process\red{,} $\lambda$ \red{is}
