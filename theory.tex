...
the leptoproduction of real photons from a nucleon \blue{or nucleus} that can be used to constrain GPDs via Compton Form Factors (CFFs). Each CFF is a convolution of a hard scattering kernel with a GPD that describes a soft part of the scattering process.
...
variable $\xi$; and the square $-Q^2=q^2$ of the \blue{of the four-momentum of the virtual photon that mediates the lepton-proton scattering process.} In the Bjorken limit of $Q^2\rightarrow\infty$ with
...
\blue{This paper provides a set of results analogous to those reported in
