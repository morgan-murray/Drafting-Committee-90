...
$x-\xi$. (b): The Bethe-H\red{ei}tler process, i.e. the emission of a real photon from the scattering or
...
which is the emission of a real photon by \red{the struck} quark from the nucleon, and the Bethe-Heitler (BH) process, which is elastic lepton-proton scattering with the
...
beam-helicity asymmetries and beam-charge asymmetries. This paper, \red{like} ref.~\cite{Air09}, presents results on the following asymmetries:
\begin{align}
...
experiment was upgraded in the target region. The work covered
  ...
  new data set to produce \red{the largest DVCS data set that will be published by H{\sc ermes}.}
The results in this paper make use of \red{the same} missing-mass technique for event selection \red{as was used in ref.~\cite{Air09}.}
