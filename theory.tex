...
The Fourier coefficients that receive leading-twist contributions are $c_{0,\textrm{unp}}^{\textrm{I}}$, \red{$c_{1,\textrm{unp}}^{\textrm{I}}$ and $s_{1,\textrm{unp}}^{\textrm{I}}$}. All of these Fourier coefficients have a dominant contribution from the $\mathcal{C}_{\textrm{unp}}^{\textrm{I}}$-function:
\begin{eqnarray}
