...
construction of a longitudinal-momentum-dissected transverse spatial map of parton \red{densitie}s~\cite{Bur00}. \red{The GPDs appear in experimental measurements in the form of complex-valued Compton Form Factors (CFFs), which are flavour-sums of convolutions of GPDs with hard scattering kernels. Constraints on these CFFs, and thus GPDs, can be obtained from measurements of exclusive physics processes. In particular, the exclusive leptoproduction of real photons from a nucleon or nucleus ( $e\,N\,\rightarrow\,e'\,N'\,\gamma$; see fig.~\ref{spin}) is the simplest to describe and is the most widely-used reaction channel for such work (see \cite{Air00,Air00b,Air01,Air01a,Air02,Air03,Air04,Air06,Air08,Air08a,Air09,Air09a,Air09b,Air10,Air10a,Air10b,Air10c,Air11,Air11a,Air11b}).}
...
helicity of the lepton beam and $e_\ell$ is the \red{sign of the} charge of
...
The Fourier coefficients that receive leading-twist contributions are $c_{\textrm{unp},0}^{\textrm{I}}$, \red{$c_{\textrm{unp},1}^{\textrm{I}}$ and $s_{\textrm{unp},1}^{\textrm{I}}$}. All of these Fourier coefficients have a dominant contribution from the $\mathcal{C}_{\textrm{unp}}^{\textrm{I}}$-function:
\begin{eqnarray}
...
Compared to the analysis in ref.~\cite{Air09}, the analysis presented here additionally includes a larger, independent data set taken during the years 2006 and 2007 \red{and makes use of the same missing-mass technique for event selection as was used in ref.~\cite{Air09}.} The work covered in this publication \red{further} combines the data taken in 1996-2005 with this new\red{er} data set to produce the \red{statistically most precise DVCS measurements} that will be published by H{\sc ermes}.
