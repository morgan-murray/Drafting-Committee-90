...
transfer to the target nucleon in the scattering process with \blue{$P$ ($P^{\prime}$})
...
to cross sections taken with beam spin parallel \blue{(anti-parallel)} with the
beam momentum.
