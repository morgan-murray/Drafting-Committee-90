...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{covMat2DLow.pdf}
\caption{\red{The covariance matrix results for the 2D projection fits for the bin of $0.03 \leq x_{\textrm{B}} < 0.08$. The size of the correlation is given by the size of the symbol. Filled symbols represent positive values, open symbols represent negative values.}}
\label{pic:covmatlow}
\end{figure}
