...
\hline
\hline
Overall &  0.117 & 0.097 &  2.521 &  -0.222  $\pm$  0.023  $\pm$   0.022 &
...
An additional 3.4\,\% scale uncertainty is present in the amplitudes due to the \red{precision} of
...
An additional 3.2\,\% scale uncertainty is present in the amplitudes due to the \red{precision} of
the beam polarisation measurement.
}
\end{table}
