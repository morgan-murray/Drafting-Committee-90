...
production is predominantly due to the failure to identify one photon from the decay of $\pi^0$ mesons. The procedure for estimating the corresponding
...
input from the GPD model at the average $-t$, $x_{\textrm{B}}$ and
...
independent scale uncertainty. The systematic uncertainty shown for each
