...
The data sample in the exclusive region contains events \red{not only} involving production of real photons in which the proton remains intact, \red{but also}
